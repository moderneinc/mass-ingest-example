...
ARG MODERNE_CLI_VERSION=2.5.19
...
#RUN java -jar mod.jar config build maven settings edit <path-to-maven-settings.xml>
...
# COPY /path/to/your/certs/cacerts /usr/lib/jvm/temurin-8-jdk/jre/lib/security/cacerts
# COPY /path/to/your/certs/cacerts /usr/lib/jvm/temurin-11-jdk/lib/security/cacerts
# COPY /path/to/your/certs/cacerts /usr/lib/jvm/temurin-17-jdk/lib/security/cacerts
...
# TODO Configure Git clone credentials
